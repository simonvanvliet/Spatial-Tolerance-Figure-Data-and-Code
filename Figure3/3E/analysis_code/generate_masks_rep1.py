...
df = pd.read_csv('1_fluo_binary_ext_H_R_rep1.csv')
...
base_dir = os.path.join(data_archive_path, 'Image_Data/Figure3/ext_H_R/replicate_1')

positions = ['pos10', 'pos11', 'pos12', 'pos13', 'pos14', 'pos15', 'pos16', 'pos17', 'pos19']
closing_radius = 7
