...
df = pd.read_csv('1_fluo_binary_wt_rep3.csv')
...
base_dir = os.path.join(data_archive_path, 'ToleranceAssay/2_wt/replicate_3')

positions = ['pos2', 'pos3', 'pos4', 'pos6', 'pos8', 'pos10', 'pos12', 'pos14', 'pos15', 'pos17']
closing_radius = 7
